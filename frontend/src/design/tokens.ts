export const colors = {
  ...
  surface2: "#16161d",
  surface3: "#1c1c24",
  surfaceGlass: "rgba(22, 22, 29, 0.72)",
  panel: "#16161d",
  ...
  text: "#f5f5f7",
  mutedText: "rgba(245, 245, 247, 0.66)",
  hairline: "rgba(255, 255, 255, 0.08)",
  innerHighlight: "inset 0 1px 0 rgba(255, 255, 255, 0.06)",
  ih1: "inset 0 1px 0 rgba(255, 255, 255, 0.04)",
  ih2: "inset 0 1px 0 rgba(255, 255, 255, 0.06)",
  ih3: "inset 0 1px 0 rgba(255, 255, 255, 0.08)",
  accent: "#E8A33D",
  accentQuiet: "#D89636",
  accentHover: "#F2B861",
...
export const circuit = {
  trackSurface: "#1F1F26",
  trackEdge: "rgba(255, 255, 255, 0.10)",
...
export const typography = {
  ...
  sizes: {
    display: ["clamp(3rem, 7vw, 4.5rem)", { lineHeight: "1.05" }],
    hero: ["clamp(2.25rem, 5.4vw, 3.5rem)", { lineHeight: "1.1" }],
    sectionTitle: ["2rem", { lineHeight: "1.15" }],
    cardHeading: ["1.25rem", { lineHeight: "1.2" }],
    body: ["1.0625rem", { lineHeight: "1.65" }],
    secondaryBody: ["0.9375rem", { lineHeight: "1.55" }],
